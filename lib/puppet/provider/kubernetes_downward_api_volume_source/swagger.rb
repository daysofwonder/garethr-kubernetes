...
Puppet::Type.type(:kubernetes_downward_api_volume_source).provide(:swagger, :parent => PuppetX::Puppetlabs::Kubernetes::Provider) do
  ...
  def create
    Puppet.info("Creating kubernetes_downward_api_volume_source #{name}")
    create_instance_of('downward_api_volume_source', name, build_params)
  end
  ...
  def self.list_instances
    list_instances_of('downward_api_volume_source')
  end
