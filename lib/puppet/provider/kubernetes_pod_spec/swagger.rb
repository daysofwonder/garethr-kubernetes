...
Puppet::Type.type(:kubernetes_pod_spec).provide(:swagger, :parent => PuppetX::Puppetlabs::Kubernetes::Provider) do
  ...
  def self.instance_to_hash(instance)
    ...
    name: instance.metadata.name,
        ...
        volumes: hash_arrays(volumes),
      
      
    
      
      
        init_containers: hash_arrays(initContainers),
      
      
    
      
      
        containers: hash_arrays(containers),
        ...
        image_pull_secrets: hash_arrays(imagePullSecrets),
        ...
        tolerations: hash_arrays(tolerations),
      
      
    
      
      
        host_aliases: hash_arrays(hostAliases),
        ...
        readiness_gates: hash_arrays(readinessGates),
