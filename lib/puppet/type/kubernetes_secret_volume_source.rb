  ...
  newparam(:name, namevar: true) do
    desc 'Name of the secret_volume_source.'
      ...
      newproperty(:secret_name) do
        ...
        desc "Name of the secret in the pod's namespace to use. More info: https://kubernetes.io/docs/concepts/storage/volumes#secret"
      ...
      newproperty(:optional) do
        ...
        desc "Specify whether the Secret or it's keys must be defined"
