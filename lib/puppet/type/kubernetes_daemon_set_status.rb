  ...
  newparam(:name, namevar: true) do
    desc 'Name of the daemon_set_status.'
      ...
      newproperty(:current_number_scheduled) do
        ...
        desc "The number of nodes that are running at least 1 daemon pod and are supposed to run the daemon pod. More info: http://releases.k8s.io/HEAD/docs/admin/daemons.md"
      ...
      newproperty(:number_misscheduled) do
        ...
        desc "The number of nodes that are running the daemon pod, but are not supposed to run the daemon pod. More info: http://releases.k8s.io/HEAD/docs/admin/daemons.md"
      ...
      newproperty(:desired_number_scheduled) do
        ...
        desc "The total number of nodes that should be running the daemon pod (including nodes correctly running the daemon pod). More info: http://releases.k8s.io/HEAD/docs/admin/daemons.md"
