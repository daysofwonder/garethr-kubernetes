...
Puppet::Type.newtype(:kubernetes_replication_controller_condition) do
...
apply_to_all
  ...
  newparam(:name, namevar: true) do
    desc 'Name of the replication_controller_condition.'
  end
      ...
      newproperty(:type) do
        ...
        desc "Type of replication controller condition."
      ...
      newproperty(:last_transition_time) do
        ...
        desc "The last time the condition transitioned from one status to another."
