  ...
  newparam(:name, namevar: true) do
    desc 'Name of the pod_status.'
      ...
      newproperty(:init_container_statuses) do
        ...
        desc "The list has one entry per init container in the manifest. The most recent successful init container will have ready = true, the most recently started container will have startTime set. More info: http://kubernetes.io/docs/user-guide/pod-states#container-statuses"
