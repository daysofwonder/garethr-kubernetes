...
Puppet::Type.newtype(:kubernetes_job_condition) do
...
apply_to_all
  ...
  newparam(:name, namevar: true) do
    desc 'Name of the job_condition.'
  end
  
    
      newproperty(:type) do
        
        desc "Type of job condition, Complete or Failed."
      ...
      newproperty(:last_probe_time) do
        ...
        desc "Last time the condition was checked."
